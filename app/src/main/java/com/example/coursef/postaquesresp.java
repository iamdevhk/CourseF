...
public class postaquesresp extends AsyncTask<Void, Void, Void> {
    Context context; //context for opening intents from afterexecute
    public String freak=Second.url;
    public postaquesresp(Context context) {
    ...
    public String ques=postaquestion.name;
    ...
    protected Void doInBackground(Void... voids) {
        ...
        String url = freak+"api/addquestion?email=" + email+"&course="+ course+"&ques="+ ques;
        //hk=0;
        Log.v("Hk", url);
