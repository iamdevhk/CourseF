...
public class faccoursesdynamic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faccoursesdynamic);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                if (position == 0) {
                    if(ch==2){
                        Intent dbms = new Intent( faccoursesdynamic.this, facformalfeedback.class);
                        dbms.putExtra("course", course);
                        startActivity(dbms);}
                    else if(ch==1)
                    {
                        Intent dbms = new Intent( faccoursesdynamic.this, discussion_forum.class);
                        dbms.putExtra("course", course);
                        startActivity(dbms);
                    ...
                    {
                        Toast.makeText(faccoursesdynamic.this, "You dont have access to this section", Toast.LENGTH_SHORT).show();
    ...
    public void sendRequest(){
        ...
        String request_url = freak+"api/getcourseFac?email="+email;
